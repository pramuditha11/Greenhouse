...
<html>
  <head>
    <title>GREENHOUSE WITH MYSQL DATABASE</title>
  ...
  <body>
    <div class="topnav">
      <h3>GREENHOUSE WITH DATABASE</h3>
    </div>
    
    <br>
    
    <h3 style="color: #0c6980;">GREENHOUSE RECORD DATA TABLE</h3>
    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          include 'database.php'; // Adjust this path to match the actual location of your database connection file.
          $num = 0;
          //------------------------------------------------------------
          ...
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">' . $row['fertilizer'] . '</td>';
            echo '<td class="bdr">' . $row['Water_level'] . '</td>';
            echo '<td class="bdr">' . $row['FAN_01'] . '</td>';
            echo '<td class="bdr">' . $row['FAN_02'] . '</td>';
